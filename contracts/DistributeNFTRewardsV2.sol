...
contract DistributeNFTRewardsV2 is Initializable, OwnableUpgradeSafe {
    ...
    function extractEarnings(address _to) public {
        ...
        uint256 earnings = getEarnings(_to);
        lastPriceEarningsExtracted[_to] = tokenFeePrice;
        accomulatedRewards = accomulatedRewards.sub(earnings);
        IERC20(rewardToken).transfer(_to, earnings);
    }

    function getEarnings(address _to) public view returns(uint256) {
