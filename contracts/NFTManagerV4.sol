...
contract NFTManagerV4 is Initializable, OwnableUpgradeSafe, ERC721UpgradeSafe {
    ...
    function safeMint(string memory _tokenURI) public {
        ...
        IERC20(yeld).transferFrom(msg.sender, distributeNFTRewards, cost.sub(dev).sub(distributionToOthers));
        IDistributeNFTRewards(distributeNFTRewards).lockLiquidity(msg.sender, cost.sub(dev).sub(distributionToOthers));
